...
class ResultScreen:
    ...
    def __init__(self, estado):
        ...
        # imagem de fundo da tela de vitoria
    ...
    def desenhar(self, tela):
        ...
        # --- TELA DE GAME OVER ---
        if self.estado == GameState.GAME_OVER:
            # desenha o fundo da tela de game over
            tela.blit(self.background, (0, 0))

            # setinhas quando o mouse passa em cima do botao
            if self.rect_reiniciar.collidepoint(posicao_mouse):
        ...
        # --- TELA DE VITÓRIA ---
            ...
            # desenha o fundo da tela de vitoria
            tela.blit(self.background, (0, 0))
